...
Mac/Sat/SlottedAloha set mean_backoff_ 1s ; # mean exponential backoff time(s)
Mac/Sat/SlottedAloha set rtx_limit_ 10; # max number of retrans. attempted 
