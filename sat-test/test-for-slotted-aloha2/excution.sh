...
filtxt="sat-test/test-for-slotted-aloha2/record.txt"
filawk="sat-test/test-for-slotted-aloha2/throughput.awk"
filtcl="sat-test/test-for-slotted-aloha2/sat-aloha.tcl"

echo "Slotted ALOHA" >> $filtxt
echo "stop_time	sent_pkts	success_pkts">> $filtxt
