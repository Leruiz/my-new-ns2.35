...
filtxt="sat-test/test-for-pure-aloha-delay/record.txt"
filawk="sat-test/test-for-pure-aloha-delay/delay.awk"
filtcl="sat-test/test-for-pure-aloha-delay/sat-aloha.tcl"
